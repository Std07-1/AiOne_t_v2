...
AiOne_t — це трейдинговий бот, розроблений для автоматизації процесу трейдингу з використанням різних алгоритмів і стратегій. Цей проект належить [Stanislav Std07-1](https://github.com/Std07-1).
